...
#
# Description:
# Doble U-Net model train over Drive dataset
#
# References:
...
def main(args):
    ...
    print("Model summary:")
    eddl.summary(net)
    eddl.setlogfile(net, "models/double_unet_drive.log")
    ...
    eddl.save(net, "models/double_unet_drive.bin")
    


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--epochs", type=int, metavar="INT", default=32)
    parser.add_argument("--batch-size", type=int, metavar="INT", default=2)
    parser.add_argument("--num-batches", type=int, metavar="INT", default=128)

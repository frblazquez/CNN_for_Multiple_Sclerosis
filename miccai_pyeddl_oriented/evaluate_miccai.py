...
MODEL_PATH  = "/scrap/users/blazquez/train_double_unet/models/double_unet_miccai_"
PROFILE_CMD = "nvidia-smi --query-gpu=power.draw,utilization.gpu,utilization.memory,temperature.gpu,pstate --format=csv,nounits --id=0 -lms 1000 -f ./profiles/tr_dice/GPUprofile_v100_e"

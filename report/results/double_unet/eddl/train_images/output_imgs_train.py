...
eddl.build(
    ...
    ["mse"],
    eddl.CS_CPU(mem="low_mem") # Much better to do this with GPU if available!
)
...
for model_idx in range(29,30):
    ...
    for img_idx in IMAGES_IDXS:
        ...
        out_tensor.save("tr"+str(img_idx)+"/tr"+str(img_idx)+"_e"+str(model_idx)+"_pred.jpg")

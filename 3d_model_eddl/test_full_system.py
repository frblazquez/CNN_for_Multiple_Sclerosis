...
fh = open("train_logging/train_stats_full_system_memory.txt","w+")
...
# config = tf.compat.v1.ConfigProto(device_count={"CPU": 3},
...
fig.savefig('../figures/model0_val_training_curve.png')
...
plt.ylabel('Accuracy')
plt.legend(loc='lower right')
fig.savefig('../figures/model1_val_training_curve.png')
